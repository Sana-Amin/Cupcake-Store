...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("We are in the middle of creating the cupcake menu. We currently have three cupcakes on the menu but need to decide on pricing.");
 ...
 class Cupcake {
    ...
    public void type(){
        System.out.println("A basic cupcake, with vanilla frosting");
    }
}
...
class Chocolate extends Cupcake{
    ...
    public void type(){
        System.out.println("A chocolate based, with chocolate frosting");
    }
